...
public class DBHelper extends SQLiteOpenHelper {
  ...
  //  db.execSQL("create table " + TABLE_LECTURERS + "(" +KEY_ID+" integer primary key,"+KEY_NAME+" text"+")");
...
/*        ContentValues contentValuesL= new ContentValues();
        contentValuesL.put(DBHelper.KEY_NAME, "Кулаков Кирилл Александрович");
        contentValuesL.put(DBHelper.KEY_NAME, "Кулаков Кирилл Александрович");
        contentValuesL.put(DBHelper.KEY_NAME, "Кулаков Кирилл Александрович");
        contentValuesL.put(DBHelper.KEY_NAME, "Кулаков Кирилл Александрович");
        db.insert(DBHelper.TABLE_SUBJECTS, null, contentValuesL);*/
    }
